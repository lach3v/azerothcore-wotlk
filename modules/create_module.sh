...
then
    ...
    # ## git@gitlab.com:azerothcore_vip/azerothcore-wotlk.git
    # ## https://gitlab.com/azerothcore_vip/azerothcore-wotlk.git

    # ## git@github.com:azerothcore/azerothcore-wotlk.git
    # ## https://github.com/azerothcore/azerothcore-wotlk.git

    # ## git@bitbucket.org:Barbz/sunwellcore.pl-by-maczuga.git
    # ## https://Barbz@bitbucket.org/Barbz/sunwellcore.pl-by-maczuga.git
